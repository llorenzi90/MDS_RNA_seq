...
setwd("/home/llorenzi/shares/INVESTIGACIO/Cuartero Group/CUARTERO GROUP/MDS/RNA-seq/analyses/DESeq2/")
dir.create("GSEA")
setwd("GSEA")
...
for(gset in list.files("/home/llorenzi/shares/INVESTIGACIO/Cuartero Group/CUARTERO GROUP/references/human/gene_sets/",pattern = ".gmt",full.names = T)){
  #rank_file='/home/llorenzi/shares/INVESTIGACIO/Cuartero Group/CUARTERO GROUP/MDS/RNA-seq/analyses/DESeq2/all_samples/cohesin_vs_nocohesin/rank_files/all_samples_CohesinvsNoCohesin_DESeq2.rnk'
  #relrank=get_relative_path('/home/llorenzi/shares/INVESTIGACIO/Cuartero Group/CUARTERO GROUP/MDS/RNA-seq/analyses/DESeq2/all_samples/cohesin_vs_nocohesin/rank_files/all_samples_CohesinvsNoCohesin_DESeq2.rnk')
...
write(commands,"~/shares/INVESTIGACIO/Cuartero Group/CUARTERO GROUP/MDS/RNA-seq/scripts/run_GseaPreranked_MDS_DESeq2.sh")
getwd()
#run this script from "/home/llorenzi/shares/INVESTIGACIO/Cuartero Group/CUARTERO GROUP/MDS/RNA-seq/analyses/DESeq2/GSEA"