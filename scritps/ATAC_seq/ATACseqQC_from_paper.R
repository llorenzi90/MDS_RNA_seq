...
bamfile <- args[1]
setwd("~/MDS/ATAC-seq/data/bam_files/")
bamfile <- "AT-MDS35.1.primary_chr.quality.concordant.sorted.markedDups.bam"
...
genome <- Hsapiens
objs <- splitGAlignmentsByCut(gal1, txs=txs, genome=genome, conservation = phastCons100way.UCSC.hg38)
