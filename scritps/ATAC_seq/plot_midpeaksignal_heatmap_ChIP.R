...
Ntop="all" #top peaks to pick based on macs2 qval
#
sort_by="CPM"
...
#midpoints <- start(coords) + round( width(coords)/2) #old WRONG!!
...
#take the top Ntop extended granges or all peaks if less than Ntop
if(Ntop!="all"){
